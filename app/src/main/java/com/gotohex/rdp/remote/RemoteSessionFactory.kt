            ...
            ProtocolType.RDP -> {
                val rdpFactory = { host: String, port: Int ->
                    RdpRemoteAdapter(
                        ...
                        // BUG-FLAGS FIX: profile.performanceFlags stores the UI-level
                        // choice (0..4), but the native bridge forwards this value
                        // verbatim into FreeRDP_PerformanceFlags, which is a real
                        ...
                        performanceMode    = RdpPerformance.flagsFor(profile.performanceFlags),
