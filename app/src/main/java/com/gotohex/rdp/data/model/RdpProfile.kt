...
object RdpPerformance {
    ...
    /**
     * Converts a UI-level performance setting ([LOW_BANDWIDTH]..[AUTO]) into the
     * actual FreeRDP_PerformanceFlags bitmask that should be sent to the native
     * bridge. AUTO/LAN intentionally return 0 (no effects disabled); network-aware
     * auto-detection is handled separately via FreeRDP_NetworkAutoDetect.
     */
